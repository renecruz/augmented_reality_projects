...
public abstract class AbstractArchitectCamActivity extends Activity implements ArchitectViewHolderInterface{
	...
	public void onCreate( final Bundle savedInstanceState ) {
		...
		Log.d("ONCREATE-->","Find  view: " + this.getArchitectViewId());
		...
		Log.d("ONCREATE-->","License: " + this.getWikitudeSDKLicenseKey());
		Log.d("ONCREATE-->","Features: " + this.getFeatures());
		Log.d("ONCREATE-->","CameraPosition: " + this.getCameraPosition());

		try {
			/* first mandatory life-cycle notification */
			Log.d("NULL:",this.architectView + "");
	...
	/**
	 * @return layout id of your youlayout.xml that holds an ARchitect View, e.g. R.layout.camview
	 */
	@Override
